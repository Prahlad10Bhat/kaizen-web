      ...
      <div className="relative z-10">
        ...
        <section className="py-32 relative overflow-hidden bg-[#050505] flex flex-col items-center">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6 mb-12">
            ...
            <button className="px-6 py-3 rounded-full bg-kaizen-purple text-white font-semibold text-sm hover:bg-kaizen-purple-light transition-colors flex items-center gap-2 shadow-[0_0_20px_rgba(99,102,241,0.3)]">
