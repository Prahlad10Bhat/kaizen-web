      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-bold text-xl tracking-tight text-white">Kaizen</span>
            </div>
            <p className="text-zinc-400 max-w-sm mb-6 leading-relaxed">
              The ultimate productivity system designed to help you build better habits, manage tasks, and achieve your goals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["About", "Blog", "Careers", "GitHub", "Brand"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-zinc-500 hover:text-white transition-colors text-sm">
                    {item}
                  </a>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-zinc-600 text-sm">
            © {new Date().getFullYear()} Kaizen, Inc. All rights reserved.
          </p>
