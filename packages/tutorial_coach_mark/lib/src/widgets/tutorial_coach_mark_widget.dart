    ...
    children = currentTarget!.contents!.map<Widget>((i) {
      switch (i.align) {
        case ContentAlign.bottom:
          {
            // Auto flip to top if too close to the bottom of the screen
            if (positioned.dy > ancestorBox.size.height * 0.6) {
              top = null;
            ...
            double contentWidth = 400; // max width of content
            left = positioned.dx - (contentWidth / 2);
            if (left! < 20) left = 20;
            if (left! + contentWidth > ancestorBox.size.width - 20) {
              left = null;
              right = 20;
              width = contentWidth;
            } else {
        ...
        case ContentAlign.top:
          {
            // Auto flip to bottom if too close to the top of the screen
            if (positioned.dy < ancestorBox.size.height * 0.4) {
              top = positioned.dy + haloHeight;
              bottom = null;
            } else {
              top = null;
